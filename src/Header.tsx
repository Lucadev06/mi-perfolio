      ...
      <IconButton onClick={() => setIsDrawerOpen(true)}>
        <MenuIcon sx={{ color: "white" }} />
                    ...
                    >
                        ...
                        >
                            <Button variant="text" className="boton-menu" onClick={() => redirect("/app")}>
                                Inicio
                            </Button>
                            <Button variant="text" className="boton-menu" onClick={() => redirect("/sobre-mi")}>
                                Sobre mí
                            </Button>
                            <Button variant="text" className="boton-menu" onClick={() => redirect("/skills")}>
                                Skills
                            </Button>
                            <Button variant="text" className="boton-menu" onClick={() => redirect("/experiencia")}>
                                Experiencia
                            </Button>
                            <Button variant="text" className="boton-menu" onClick={() => redirect("/contacto")}>
                                Contacto
                            </Button>
                        </Box>
                    </Drawer>
